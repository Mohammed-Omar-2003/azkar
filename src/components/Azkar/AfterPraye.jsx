...
import { fetchAfterPraye } from "../../redux/efterPrayeSlice";
...
function AfterPraye() {
  ...
  const { element } = useSelector((state) => state.efterPraye); //array
  useEffect(() => {
    dispatch(fetchAfterPraye());
  }, [dispatch]);
  ...
  return (
    <div className={style.evening}>
      <div className={style.header}>
        <span>أذكار بعد الصلاه المفروضة</span>
